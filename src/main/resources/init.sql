...
MySQL - 5.7.17-log : Database - boot-security
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`boot-security` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci */;
...
insert  into `sys_user`(`id`,`password`,`username`) values (1,'123456','JhonRain'),(2,'123456','XZL');
